...
<form action="<?= PATH ?>/index.php?p=fabricants/newFabricant" method="POST">
...
<table class="table table-secondary table-hover">
    ...
    <?php foreach ($allFabricants as $fabricant) : ?>
        <tr>
            ...
            <td>
                <a href="<?= PATH ?>/index.php?p=fabricants/edit/<?= $fabricant['ID_FABRICANT'] ?>">
                    <button class='btn btn-info btn-sm fas fa-pencil-alt fa-sm'></button></a>
                <a onclick="return confirm('Etes vous sur de vouloir supprimer ce fabricant ?')" href="<?= PATH ?>/index.php?p=fabricants/deleteFabricant/<?= $fabricant['ID_FABRICANT']?>">
